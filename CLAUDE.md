...
- The showcase site is generated: after changing the page, the deck, or the recording, run `python3 site/build.py` and commit the result. Bump the `?v=` tag on the page's assets when its scripts or styles change.
