...
Add and configure a camera component, verify the feed, and capture an image programmatically.
> Source: https://docs.viam.com/hardware/common-components/add-a-camera/
...
**Images are dim on start up when capturing data**
