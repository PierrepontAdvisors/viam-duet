...
Add and configure a switch component to read and set the position of a multi-position switch.
> Source: https://docs.viam.com/hardware/common-components/add-a-switch/
...
**GetPosition returns unexpected values**
