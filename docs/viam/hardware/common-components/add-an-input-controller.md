...
Add and configure a gamepad, joystick, or other input device for manual machine control.
> Source: https://docs.viam.com/hardware/common-components/add-an-input-controller/
...
**Buttons or axes map to wrong controls**
