...
Add and configure an encoder to track motor position and direction.
> Source: https://docs.viam.com/hardware/common-components/add-an-encoder/
...
**Count always increases (never decreases)**
...
**Position is inaccurate or drifts**
