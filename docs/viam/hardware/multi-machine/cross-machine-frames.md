...
Attach a remote part's components into your machine's frame tree with the correct spatial offset.
> Source: https://docs.viam.com/hardware/multi-machine/cross-machine-frames/
