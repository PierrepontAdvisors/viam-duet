...
Attach a second computer to your existing machine as a sub-part so the main part can access its components.
> Source: https://docs.viam.com/hardware/multi-machine/add-a-sub-part/
