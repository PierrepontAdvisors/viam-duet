...
Review what you built in the pick-and-place workshop, the parts of the Viam platform you exercised, and where to take your solution next.
> Source: https://docs.viam.com/tutorials/pick-and-place/wrap-up/
...
<nav class="workshop-nav" aria-label="Workshop phase navigation"><div class="workshop-nav-links"><a class="workshop-nav-prev" href="/tutorials/pick-and-place/inline-module/">&larr; Previous</a></div>
</nav>
