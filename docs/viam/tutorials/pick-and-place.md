...
Build a vision-guided robot that detects blocks by shape and places them into a bin with motion planning, from manual control to programming an autonomous workflow in Python.
> Source: https://docs.viam.com/tutorials/pick-and-place/
...
<source srcset="/tutorials/pick-and-place/hero-hardware-overview_hu_872431867dec6b92.webp" type="image/webp" width="1200" height="1600">
<img src="/tutorials/pick-and-place/hero-hardware-overview.jpeg" width="1200" height="1600" alt="The staged pick-and-place workstation: a uFactory xArm6 arm with a two-finger gripper and a wrist-mounted RealSense camera, colored blocks, and a bin." class="" id="" style="" loading="lazy">
...
<source srcset="/tutorials/pick-and-place/live-indicator_hu_347df98866acaa0b.webp" type="image/webp" width="1200" height="707">
<img src="/tutorials/pick-and-place/live-indicator.png" width="1200" height="707" alt="A Viam machine page showing the green Live indicator." class="" id="" style="" loading="lazy">
