...
> Source: https://docs.viam.com/organization/rbac/
...
You can assign an owner or an operator role for an [organization](/manage/reference/organize/)
, [location](/manage/reference/organize/)
, or [machine](/fleet/machines/)
.
...
Permissions for managing [machines](/fleet/machines/)
 are as follows:
...
| Add a new [part](/reference/glossary/part/)
 | **Yes** | No | **Yes** | No | **Yes** | No |
| Edit [part](/reference/glossary/part/)
...
Permissions for managing [locations](/manage/reference/organize/)
 are as follows:
...
Only [organization](/manage/reference/organize/)
 owners can edit or delete an organization, or see and edit the organization billing page.
...
Permissions for managing [fragments](/manage/fleet/reuse-configuration/)
 are as follows:

<!-- prettier-ignore -->
| Permissions | Org owner | Org operator | Location owner | Location operator | Machine owner | Machine operator |
| ----------- | --------- | ------------ | -------------- | ----------------- | ------------- | ---------------- |
| Create a new fragment in the [org](/manage/reference/organize/)
 | **Yes** | No | No | No | No | No |
| See and use fragments in the [org](/manage/reference/organize/)
 | **Yes** | No | **Yes** | No | **Yes** | No |
