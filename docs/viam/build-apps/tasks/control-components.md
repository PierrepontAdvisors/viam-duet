...
Read from sensors and control motors, arms, and other actuators from your app using the SDK component clients.
> Source: https://docs.viam.com/build-apps/tasks/control-components/
