...
Set up a project for writing a Viam app in C++: an embedded application, a high-performance service, or any other C++ program that talks to a Viam machine.
> Source: https://docs.viam.com/build-apps/setup/cpp/
