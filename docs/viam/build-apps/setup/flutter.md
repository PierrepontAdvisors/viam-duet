...
Set up a project for building a Viam app that runs across iOS, Android, and desktop platforms from a single codebase.
> Source: https://docs.viam.com/build-apps/setup/flutter/
