...
Set up a project for writing a Viam app in Go: a backend service, a fleet orchestrator, a CLI tool, or any other Go program that talks to a Viam machine.
> Source: https://docs.viam.com/build-apps/setup/go/
