...
Set up a project for building a Viam mobile app using React Native specifically. For new cross-platform apps, prefer Flutter.
> Source: https://docs.viam.com/build-apps/setup/react-native/
