...
Set up a project for writing a Viam app in Python: a control script, a backend service, a data pipeline, or any other Python program that talks to a Viam machine.
> Source: https://docs.viam.com/build-apps/setup/python/
