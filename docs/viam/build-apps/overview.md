...
Build software that uses a Viam SDK to talk to your machines and the Viam cloud, from web dashboards to long-running backend services.
> Source: https://docs.viam.com/build-apps/overview/
