# How Viam client apps connect

The transport paths the SDK uses, the session safety mechanism, and what the SDK reconnects automatically.
> Source: https://docs.viam.com/build-apps/concepts/how-apps-connect/
