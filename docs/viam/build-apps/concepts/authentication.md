# Authenticating Viam client apps

The credential types a Viam client app uses and when to use each. Covers API keys, access tokens, and hosted-app credential injection.
> Source: https://docs.viam.com/build-apps/concepts/authentication/
