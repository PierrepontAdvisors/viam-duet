...
Host a browser-based Viam app on Viam Applications with built-in authentication, credential injection, and a dedicated URL.
> Source: https://docs.viam.com/build-apps/hosting/overview/
