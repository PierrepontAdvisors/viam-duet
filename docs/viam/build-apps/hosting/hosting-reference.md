# Viam Applications hosting platform reference

URL patterns, cookie structure, caching behavior, and limits for the Viam Applications hosting platform.
> Source: https://docs.viam.com/build-apps/hosting/hosting-reference/
