...
Reference for the applications array in meta.json, which declares one or more Viam Applications for hosted deployment.
> Source: https://docs.viam.com/build-apps/hosting/meta-json-reference/
