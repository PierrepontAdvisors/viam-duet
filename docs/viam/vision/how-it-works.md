...
Why Viam splits ML inference into two services, what each one does, and how they compose to produce detections, classifications, and point cloud objects.
> Source: https://docs.viam.com/vision/how-it-works/
