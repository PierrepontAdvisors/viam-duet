# Segment 3D objects from point clouds

Use the vision service's GetObjectPointClouds method to find and label objects in 3D space, combining a 2D detector with a depth camera's point cloud.
> Source: https://docs.viam.com/vision/3d-vision/segment-3d/
...
**GetObjectPointClouds returns an error about unsupported operation**
...
**Segmenter starts but returns no objects**
...
**Object shapes look very noisy or hollow**
