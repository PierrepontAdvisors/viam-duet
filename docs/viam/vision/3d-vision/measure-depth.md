...
Retrieve point clouds and depth images from a depth camera, read depth at specific pixels, and measure distance to detected objects.
> Source: https://docs.viam.com/vision/3d-vision/measure-depth/
...
**Point cloud is empty or has very few points**
...
**Depth values are zero at some pixels**
...
**Depth measurements are inaccurate**
...
**"GetPointCloud not supported" error**
