...
Use a vision service to classify images by label and confidence, make decisions based on classification, and monitor scenes continuously.
> Source: https://docs.viam.com/vision/classify/
...
**All classifications have very low confidence**
...
**Classification is inconsistent between frames**
...
**Transform camera shows no overlay**
