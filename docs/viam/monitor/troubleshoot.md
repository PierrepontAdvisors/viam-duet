...
Debug a misbehaving machine using logs, remote shell access, debug endpoints, and configuration history.
> Source: https://docs.viam.com/monitor/troubleshoot/
