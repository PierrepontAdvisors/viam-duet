...
Check which machines are online, view part status, and inspect machine health across your fleet.
> Source: https://docs.viam.com/monitor/monitor/
...
Click the **status** dropdown to see details about each [part](/reference/glossary/part/)
 of your machine:
