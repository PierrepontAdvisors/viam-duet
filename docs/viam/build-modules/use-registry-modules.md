...
Before writing a module, check whether one already exists. The registry has more than hardware drivers.
> Source: https://docs.viam.com/build-modules/use-registry-modules/
