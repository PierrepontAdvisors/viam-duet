...
> Source: https://docs.viam.com/reference/components/camera/
...
| Model                       | Description                                                                                                      |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| [`webcam`](/reference/components/camera/webcam/)         | The general camera model for USB cameras and laptop webcams.                                                     |
| [`ffmpeg`](/reference/components/camera/ffmpeg/)         | Uses a camera device, video file, or stream as a camera component.                                               |
| [`transform`](/reference/components/camera/transform/)   | Applies pipeline transformations (classifications, crop, detections, resize, rotate) to another camera's output. |
| [`fake`](/reference/components/camera/fake/)             | Returns a static gradient image and point cloud, for testing.                                                    |
...
| Model                                     | Description                                             |
| ----------------------------------------- | ------------------------------------------------------- |
| [`fake`](/reference/components/camera/micro-rdk/fake/)                 | A camera model for testing.                             |
| [`esp32-camera`](/reference/components/camera/micro-rdk/esp32-camera/) | An OV2640 or OV3660 camera connected to an ESP32 board. |
