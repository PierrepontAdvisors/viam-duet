...
Reference for the gpio motor model. Brushed or brushless DC motors.
> Source: https://docs.viam.com/reference/components/motor/gpio/
...
The `gpio` model supports a DC or BLDC motor if it is wired to a motor driver that is controlled by general-purpose input/output (GPIO) pins on a [board](/components/board/)
 component.
...
| Name | Type | Required? | Description |
| ---- | ---- | --------- | ----------- |
| `a` | string | **Required** for some drivers | Board [pin number](/reference/glossary/#term-pin-number)
 this motor driver's "IN1" or "A" pin is wired to. |
| `b` | string | **Required** for some drivers | Board [pin number](/reference/glossary/#term-pin-number)
 this motor driver's "IN2" or "B" pin is wired to. |
| `dir` | string | **Required** for some drivers | Board [pin number](/reference/glossary/#term-pin-number)
 this motor driver's direction ("DIR") pin is wired to. |
| `pwm` | string | **Required** for some drivers | Board [pin number](/reference/glossary/#term-pin-number)
 this motor driver's "PWM" pin is wired to. |
