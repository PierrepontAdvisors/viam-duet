...
Reference for the fake motor model. Fake motor to test software without any hardware.
> Source: https://docs.viam.com/reference/components/motor/fake/
...
| Name | Type | Required? | Description |
| ---- | ---- | --------- | ----------- |
| `a` | string | Optional | See [Pin Information](#pin-information). Corresponds to "IN1" on many driver data sheets. [Pin number](/reference/glossary/#term-pin-number)
 of the GPIO pin this is wired to on the [board](/reference/components/board/). |
| `b` | string | Optional | See [Pin Information](#pin-information). Corresponds to "IN2" on many driver data sheets. [Pin number](/reference/glossary/#term-pin-number)
 of the GPIO pin this is wired to on the [board](/reference/components/board/). |
| `dir` | string | Optional | See [Pin Information](#pin-information). [Pin number](/reference/glossary/#term-pin-number)
 of the GPIO pin this is wired to on the [board](/reference/components/board/). |
|`pwm` | string | Optional | See [Pin Information](#pin-information). [Pin number](/reference/glossary/#term-pin-number)
 of the GPIO pin this is wired to on the [board](/reference/components/board/). |
