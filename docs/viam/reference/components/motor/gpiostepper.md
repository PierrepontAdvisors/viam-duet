...
Reference for the gpiostepper motor model. Bipolar stepper motor with current regulation and 1/32 microstepping driven by a basic driver.
> Source: https://docs.viam.com/reference/components/motor/gpiostepper/
...
| `pins` | object | **Required** |  A struct containing the [board](/reference/components/board/) [pin numbers](/reference/glossary/#term-pin-number)
 that the `step` and `dir` pins of the motor driver are wired to. |
