...
> Source: https://docs.viam.com/reference/components/camera/micro-rdk/esp32-camera/
...
<source srcset="/components/camera/esp32-camera-2640_hu_af72be33ba0d5fc9.webp" type="image/webp">
<img src="/components/camera/esp32-camera-2640.png" alt="Fake Camera on the ESP32" class="shadow" id="" style="" loading="lazy">
