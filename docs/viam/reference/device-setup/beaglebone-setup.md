...
Flash a BeagleBone AI-64 to prepare it for viam-server installation.
> Source: https://docs.viam.com/reference/device-setup/beaglebone-setup/
...
<source srcset="/installation/beaglebone-setup/image4_hu_ac2bf35d02ac18ba.webp" type="image/webp" width="400" height="225">
<img src="/installation/beaglebone-setup/image4.png" width="400" height="225" alt="The front of a BeagleBone AI-64 single-board computer at a 45° angle." class="" id="" style="" loading="lazy">
