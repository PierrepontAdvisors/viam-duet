...
Image an Orange Pi Zero2 to prepare it for viam-server installation.
> Source: https://docs.viam.com/reference/device-setup/orange-pi-zero2/
...
<source srcset="/installation/thumbnails/orange-pi-zero2_hu_3a780f98631ce3be.webp" type="image/webp" width="350" height="350">
<img src="/installation/thumbnails/orange-pi-zero2.png" width="350" height="350" alt="The Orange Pi Zero2 single-board computer." class="" id="" style="" loading="lazy">
