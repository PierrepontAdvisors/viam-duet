# Machine-to-machine communication: end-to-end flow

Explanation of how a machine and its parts interact at the communication layer.
> Source: https://docs.viam.com/reference/machine-to-machine-comms/


When building a smart machine application, a user typically begins by configuring their machine which can consist of one or more [parts](/reference/glossary/part/)
.
...
RDK Part 1 will establish a bidirectional gRPC/[WebRTC](/reference/glossary/#term-webrtc)
 connection to RDK Part 2.
