...
> Source: https://docs.viam.com/reference/apis/components/button/
...
| [`GetStatus`](/reference/apis/components/button/#getstatus) | Get the current status of the button as a map of key-value pairs describing its state. |  |
