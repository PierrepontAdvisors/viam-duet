...
> Source: https://docs.viam.com/reference/apis/fleet/
...
To copy the ID of your machine [part](/reference/glossary/part/)
, select the part status dropdown to the right of your machine's location and name on the top of its page and click the copy icon next to **Part ID**:
...
<source srcset="/build/program/data-client/grab-part-id_hu_151985046c07cff6.webp" type="image/webp" width="1000" height="400">
<img src="/build/program/data-client/grab-part-id.png" width="1000" height="400" alt="Part ID displayed in the web UI." class="shadow imgzoom" id="" style="width: 500px" loading="lazy">
...
To copy the ID of your [machine](/fleet/machines/)
, click the **...** (Actions) button in the upper-right corner of your machine's page, then click **Copy machine ID**:
...
<source srcset="/fleet/app-usage/copy-machine-id_hu_bb6e2be6a638e719.webp" type="image/webp" width="1000" height="455">
<img src="/fleet/app-usage/copy-machine-id.png" width="1000" height="455" alt="Machine ID in the actions dropdown in the web UI." class="shadow imgzoom" id="" style="width: 500px" loading="lazy">
