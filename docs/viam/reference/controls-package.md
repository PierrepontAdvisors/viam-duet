...
The control package implements PID feedback control loops for encoded motors, sensor-controlled bases, and custom components.
> Source: https://docs.viam.com/reference/controls-package/
