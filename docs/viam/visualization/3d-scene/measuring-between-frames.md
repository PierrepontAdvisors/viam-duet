# Measuring between frames

Verify and adjust the spatial relationship between components using the 3D scene and measurement tool.
> Source: https://docs.viam.com/visualization/3d-scene/measuring-between-frames/
