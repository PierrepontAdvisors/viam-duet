# Editing frames visually

Add, edit, and attach geometry to frames directly in the 3D scene.
> Source: https://docs.viam.com/visualization/3d-scene/editing-frames-visually/
