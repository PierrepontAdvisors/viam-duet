...
Overlay live controls on the 3D scene: interactive controls for any resource on the machine, and a frame's point of view.
> Source: https://docs.viam.com/visualization/3d-scene/3d-scene-widgets/
