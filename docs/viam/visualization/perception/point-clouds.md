...
How depth-camera point clouds render in the 3D scene, how to adjust their display, and how to load and compare external point clouds.
> Source: https://docs.viam.com/visualization/perception/point-clouds/
