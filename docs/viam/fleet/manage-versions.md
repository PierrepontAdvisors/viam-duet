# Manage software versions and rollouts

Control which software versions reach your machines, stage rollouts with fragment tags, and verify what each machine is running.
> Source: https://docs.viam.com/fleet/manage-versions/
