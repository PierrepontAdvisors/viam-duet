...
Use the motion service to move a robot arm to a target pose (position and orientation) in 3D space.
> Source: https://docs.viam.com/motion-planning/move-an-arm/move-to-pose/
