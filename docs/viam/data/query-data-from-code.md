...
Query captured data programmatically using the Viam Python or Go SDK.
> Source: https://docs.viam.com/data/query-data-from-code/
...
> **Tip: discover your data structure:**
> 
> 
