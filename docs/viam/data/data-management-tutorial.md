# Capture, sync, and query data tutorial

Capture sensor data, sync it to the cloud, view it in the Data tab, and query it from code.
> Source: https://docs.viam.com/data/data-management-tutorial/
