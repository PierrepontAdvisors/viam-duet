# Capture data from multi-part machines

Capture and sync data from components on sub-parts and remote parts of a multi-part machine.
> Source: https://docs.viam.com/data/capture-sync/remote-parts-capture/
...
> **Do not configure capture on both parts:**
> 
> 
