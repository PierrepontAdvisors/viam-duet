# Stop or disable data capture

Stop capturing data for specific resources, all resources, or disable cloud sync.
> Source: https://docs.viam.com/data/capture-sync/stop-data-capture/
...
**Data still appearing in the cloud after disabling capture**
...
**Want to delete already-captured data**
...
**Local capture directory still has files after re-enabling sync**
