...
Record sensor data on your robot, sync it to the cloud, and query, export, or use it for ML training.
> Source: https://docs.viam.com/data/overview/
...
Data is encrypted in transit using [gRPC](/reference/glossary/#term-grpc)
 and encrypted at rest by the cloud storage provider.
