...
Structure of captured tabular data: document format, column reference, the data column, and common per-component data structures.
> Source: https://docs.viam.com/data/schema/
