...
Configure automatic image capture and cloud sync for your inspection system.
> Source: https://docs.viam.com/try/quality-inspection/part-2/
...
<source srcset="/tutorials/first-project/data-tab-images_hu_bee58dec0a5cff72.webp" type="image/webp" width="1622" height="1100">
<img src="/tutorials/first-project/data-tab-images.png" width="1622" height="1100" alt="Data tab showing a grid of captured images from the inspection camera." class="imgzoom shadow" id="" style="" loading="lazy">
...
**[Continue to Part 3: Control Logic →](/try/quality-inspection/part-3/)**
