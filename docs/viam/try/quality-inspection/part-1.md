...
Set up a camera, ML model, and vision service to detect defects.
> Source: https://docs.viam.com/try/quality-inspection/part-1/
...
Before starting this tutorial, you need the can inspection simulation running. Follow the **[Gazebo Simulation Setup Guide](/try/quality-inspection/gazebo-setup/)** to:
...
If you followed the [setup guide](/try/quality-inspection/gazebo-setup/), your machine should already be online.
...
<source srcset="/tutorials/first-project/machine-live-status_hu_858ae330e648221c.webp" type="image/webp" width="1624" height="1100">
<img src="/tutorials/first-project/machine-live-status.png" width="1624" height="1100" alt="Machine page showing the green Live status indicator next to the machine name." class="imgzoom shadow" id="" style="" loading="lazy">
...
<source srcset="/tutorials/first-project/vision-service-test_hu_50f930dd6b321e5e.webp" type="image/webp" width="1622" height="1100">
<img src="/tutorials/first-project/vision-service-test.png" width="1622" height="1100" alt="Vision service test panel showing a can detected with a bounding box and FAIL label." class="imgzoom shadow" id="" style="" loading="lazy">
...
**[Continue to Part 2: Data Capture →](/try/quality-inspection/part-2/)**
